...
/* Created on:     01/06/2018 10:38:35                          */
/*==============================================================*/
...
/*==============================================================*/
create table FRASE (
   ID_FRASE             numeric(3)           not null,
   FOLDER_FRASE         numeric(3)           null,
   VALOR_FRASE          varchar(1000)        null,
   VALOR_FRASSEETIX48   varchar(1000)        null,
   VALOR_FRASSEETIX12   varchar(1000)        null,
...
create table FRASE_TERMINO (
   ...
   ETIQUETA_PREDECESORA numeric(2)           not null,
   ETIQUETA_SUCESORA    numeric(2)           not null,
   constraint PK_FRASE_TERMINO primary key nonclustered (ID_TERMINO, ID_FRASE, ID_ORDEN)
)
go
...
create table TERMINO_ETIQUETA (
   ID_TERMINO           numeric(5)           not null,
   ID_ETIQUETA          numeric(2)           not null,
   constraint PK_TERMINO_ETIQUETA primary key nonclustered (ID_ETIQUETA, ID_TERMINO)
)
go
